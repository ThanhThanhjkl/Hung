...
<template>
  <VRow>
    ...
    <VCol cols="12">
      <!-- 👉 Deactivate Account -->
      <VCard title="Change Your Password">
        <VCardText>
          <div>
            <VCol cols="12">
              <VTextField type="password" v-model="accountDataLocal.zip" label="Current Password" placeholder="10001" />
            </VCol>
            <VCol cols="12">
              <VTextField type="password" v-model="accountDataLocal.zip" label="New Password" placeholder="10001" />
            </VCol>
            <VCol cols="12">
              <VTextField type="password" v-model="accountDataLocal.zip" label="Confirm Your New Password"
                placeholder="10001" />
            </VCol>
          </div>
